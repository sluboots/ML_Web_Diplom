                    ...
                    <GridItem colSpan={{ md: 1 }}>
                        <Box px={[4, 0]}>
                            ...
                            <Text
                                ...
                                color={"gray.600"}
                            >
                                Чтобы добавить вакансию, необходимо просто скопировать или написать текст в поле для ввода.
                                <br></br>
                                Важное примечание:
                                <br></br>
                                Вакансия должно быть строго на русском языке, допускаются, на английском языке, названия профессий, а также различные аббревиатуры.
                                <br></br>
                                Допускается добавление только одной вакансии.
                                <br></br>
                            </Text>
                        </Box>
                    </GridItem>
